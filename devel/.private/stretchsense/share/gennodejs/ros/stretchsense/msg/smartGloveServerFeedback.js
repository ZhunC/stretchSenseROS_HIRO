...
class smartGloveServerFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new smartGloveServerFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new smartGloveServerFeedback(null);
...
module.exports = smartGloveServerFeedback;
