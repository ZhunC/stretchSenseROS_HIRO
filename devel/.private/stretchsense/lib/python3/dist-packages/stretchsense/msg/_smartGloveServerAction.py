...
"""autogenerated by genpy from stretchsense/smartGloveServerAction.msg. Do not edit."""
import codecs
import sys
...
import genpy
import std_msgs.msg
import stretchsense.msg

class smartGloveServerAction(genpy.Message):
  _md5sum = "68f92041b95e919a3e758852b20bdca0"
  _type = "stretchsense/smartGloveServerAction"
...
"""
  ...
  _slot_types = ['stretchsense/smartGloveServerActionGoal','stretchsense/smartGloveServerActionResult','stretchsense/smartGloveServerActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(smartGloveServerAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = stretchsense.msg.smartGloveServerActionGoal()
      if self.action_result is None:
        self.action_result = stretchsense.msg.smartGloveServerActionResult()
      if self.action_feedback is None:
        self.action_feedback = stretchsense.msg.smartGloveServerActionFeedback()
    else:
      self.action_goal = stretchsense.msg.smartGloveServerActionGoal()
      self.action_result = stretchsense.msg.smartGloveServerActionResult()
      self.action_feedback = stretchsense.msg.smartGloveServerActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_goal.goal.goal)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.goal:
        length = len(val1)
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.goal.append(val1)
      _x = self
      start = end
      end += 12
